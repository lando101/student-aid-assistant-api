 ...
 *                   description: Error message
 */
app.get('/api/threads/:threadsId', async (req, res) => {
  try {
 ...
 *                   description: Error message
 */
app.get('/api/createthread', async (req, res) => {
  try {
      // const response = await axios.get('https://api.openai.com/v1/threads', {
      //     headers: {
      //         'Content-Type': 'application/json',
 ...
 *                   description: Error message
 */
app.post('/api/createmessage/:threadId', async (req, res) => {
  try {
 ...
 *                   description: Error message
 */
app.post('/api/runassistant/:threadId', async (req, res) => {
  try {
      const threadID = req.params.threadId;
 ...
 *                   description: Error message
 */
app.get('/api/retrieve-run/:threadId/:runId', async (req, res) => {
  try {
 ...
 *                   description: Error message
 */
app.get('/api/list-messages/:threadId', async (req, res) => {
  try {
 ...
 *                   description: Error message
 */
app.get('/api/delete-thread/:threadId', async (req, res) => {
  try {
    const { threadId } = req.params;
